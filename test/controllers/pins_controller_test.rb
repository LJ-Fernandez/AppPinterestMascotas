...
class PinsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pin" do
    assert_difference('Pin.count') do
      post pins_url, params: { pin: { descripcion: @pin.descripcion, image: @pin.image, titulo: @pin.titulo } }
    end
  ...
  test "should update pin" do
    patch pin_url(@pin), params: { pin: { descripcion: @pin.descripcion, image: @pin.image, titulo: @pin.titulo } }
